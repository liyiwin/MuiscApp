...
@Composable
fun FailureDialog(title:String, message:String, modifier: Modifier,onConfirm:()->Unit){
    Dialog(
        onDismissRequest = {},
        properties = DialogProperties(usePlatformDefaultWidth = false),
    ) {
        FailureDialogUI(title,message, modifier ,onConfirm)
    }
}
...
@RequiresApi(Build.VERSION_CODES.O)
@Composable
fun FailureDialogUI(title:String, message:String, modifier: Modifier,onConfirm:()->Unit){
    Box(
        ...
        Box(
            ...
            Card (
                ...
                Icon(
                    ...
                    contentDescription = "",
                    imageVector = ImageVector.vectorResource(id = R.drawable.ic_failure_white),
                    tint = Color.White
                )
            }
        }
