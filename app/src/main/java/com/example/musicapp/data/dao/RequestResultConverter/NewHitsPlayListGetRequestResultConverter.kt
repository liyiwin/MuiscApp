...
class NewHitsPlayListGetRequestResultConverter:GetRequestResultConverter() {

    private val gson = Gson()

    fun convertGetTotalNewHitsPlayListsOnResponse(response: Response<ResponseBody>): RequestResultWithData<List<PlayList>> {
